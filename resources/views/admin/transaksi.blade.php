...
<h1 class="text-2xl font-semibold mb-6">Kelola Transaksi</h1>
...
<div class="bg-white p-5 rounded-xl shadow mb-8">
    ...
    <form method="POST" action="/admin/transaksi">
        ...
        <div class="flex gap-4 flex-wrap">
            ...
            {{-- Pilih tipe --}}
            <select name="type" required class="border p-2 rounded w-40">
        ...
        <tbody>
            ...
            <tr class="border-b">
                ...
                <td class="py-2">
                    ...
                    @else
                        <span class="bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-xs">Proses</span>
                    @endif
                </td>
