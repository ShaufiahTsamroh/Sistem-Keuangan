...
<h1 class="text-2xl font-semibold mb-6">Kelola Pengeluaran</h1>
...
<div class="bg-white p-5 rounded-xl shadow mb-8">
    ...
    <form method="POST" action="/admin/transaksi">
        @csrf
        {{-- Tipe disembunyikan dan otomatis keluar --}}
...
<div class="bg-white p-5 rounded-xl shadow">
    <h2 class="text-lg font-semibold mb-4">Daftar Pengeluaran</h2>
