...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // POST /admin/transaksi → Admin tambah transaksi baru (langsung selesai)
        // PATCH /admin/transaksi/{transaction}/approve → Admin setujui transaksi pending
        // PATCH /admin/transaksi/{transaction}/reject → Admin tolak transaksi pending
        // DELETE /admin/transaksi/{transaction} → Admin hapus transaksi
